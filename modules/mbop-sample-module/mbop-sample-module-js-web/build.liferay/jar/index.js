Liferay.Loader.define("liferay-sample-module-js-web@0.0.0/index", ['module', 'exports', 'require', './liferay-sample-module-js-web/polyfills', './liferay-sample-module-js-web/runtime', './liferay-sample-module-js-web/main', './adapt-rt'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    const polyfills = require("./liferay-sample-module-js-web/polyfills");
    const runtime = require("./liferay-sample-module-js-web/runtime");
    const main = require("./liferay-sample-module-js-web/main");
